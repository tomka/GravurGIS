...
namespace GravurGIS.CoordinateSystems
{
	...
	public class Ellipsoid : Info, IEllipsoid
	{
        ...
        public static Ellipsoid Bessel
        {
            ...
            get
            {
                return new Ellipsoid(6377397.15508, 0, 299.1528128, true, LinearUnit.Metre, "Bessel 1841", "EPSG", 7004, "Bessel 1841", "BES", String.Empty); 
            }
        }
		#endregion
		...
		public override string WKT
		{
			get
			{
                ...
                sb.AppendFormat(CI, "SPHEROID[\"{0}\", {1}, {2}", Name, SemiMajorAxis, InverseFlattening);
